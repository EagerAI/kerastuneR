...
Later, we should concatenate all the layers and create a model via [Functional API](https://tensorflow.rstudio.com/articles/about_keras_models.html). Please, refer to the Functional API, if you want to get more details about it.
